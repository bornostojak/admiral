import connectToDockerOverSSH, { listContainerNames, listNodeNames, NodeType } from '../src/docker.js';
...
log.prefix("Node keys").debug(JSON.stringify(<NodeType>nodes[0], null, 4))
